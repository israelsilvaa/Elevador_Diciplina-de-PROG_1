...
versao = '\033[1;33m\U00002699' + "V3.0 GOLD C\033[m\033[1;31mO\033[m\033[1;32mL\033[m\033[1;34mO\033[m\033[1;35mR\033[m" # icone de engrenagem e nº de versão. :)
...
op_extras = 0
op_tempo = 0
tempo_movimentacao = float(0.85)
tempo_parada = float(3)
cor = "34m"
...
while True:
    ...
    print("2 - EXTRAS.")
    print("3 - sair.")
    apresentar = int(input("\033[4;31mOpção(1/2/3):\033[m"))
    ...
    if apresentar == 2:
        while True:
            ...
            op_extras = 999
            while True:
                print("1 - Mudar cor da Cabine do elevador.")
                print("2 - Time de Movimentação.")
                print("3 - voltar")
                op_extras = int(input("Opção(1/2/3):"))
                if op_extras == 3:
                    break
                if op_extras == 1:
                    while True:
                ...
                if op_extras == 2:
                    print("\n"*50)
                    print("1 - Modo Análise(lento)")
                    print("2 - Normal(rapido)")
                    print("3 - Personalizado(inserir manualmente o time.)")
                    op_tempo = int(input("opção(1/2/3):"))
                    if op_tempo == 1:
                        print("\n" * 50)
                        tempo_movimentacao = float(5)
                        tempo_parada = float(5)
                    elif op_tempo == 2:
                        print("\n" * 50)
                        tempo_movimentacao = float(0.85)
                        tempo_parada = float(3)
                        ...
                        print("\n" * 50)
                        tempo_movimentacao = float(input("Deslocamento de um andar p/ outro:"))
                        tempo_parada = float(input("Tempo de parada em caso de entrada de pessoas:"))
                        print("\n"*50)
            if op_extras == 3:
                print("\n" * 50)
                break
    ...
    if apresentar == 1:
        ...
        for i in range(1, 101, 3):
            print("Carregando " + str(i) + "%." + 65 * " " + versao)
            print("." * i)
            time.sleep(0.1)
            print("\n" * 50)
            if i == 100:
                print("OK!")
                print("Carregamento bem sucedido!                 Seja Bem Vindo  :)" + 24 * " " + versao)
                print("." * i)
                time.sleep(5)
        print("\n" * 50)
        ...
        while True:
            ...
            if localizacao_elevador == 3 or localizacao_elevador == 4:
                ...
                rotina = "\033[1;31mDescida\033[m depois \033[1;36mSubida\033[m"
            ...
            #Nesse momento a rodada terminou, todo mundo foi p seus lugares, e o usurio descidira se vai rodar mais
            # uma vez.
            grafico_atual(pessoas_no_elevador, localizacao_elevador, subidas, descidas, rotina, status, cor)
